        ...
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <p class="mt-2 text-sm text-gray-700">
              Here's a list of all your transactions which included receiver's name, email, amount and date.
            </p>
          </div>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <?php foreach ($transactions as $transaction) : ?>
                    <tr>
                      ...
                      <td class="whitespace-nowrap px-2 py-4 text-sm font-medium <?= $transaction['amount'] > 0 ? 'text-emerald-600' : 'text-red-600' ?>">
